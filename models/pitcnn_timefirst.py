...
class PITCNN_dynamic_timefirst(BaseModel_dynamic):
    def __init__(self, c=8):
        super(PITCNN_dynamic_timefirst, self).__init__()
        self.c = c

        self.conv11 = nn.Conv3d(2, c, kernel_size=3, padding=1, padding_mode="reflect")
        ...
        self.conv_m1 = nn.Conv3d(c * 4, c * 8, kernel_size=3, padding=1, padding_mode="reflect")
